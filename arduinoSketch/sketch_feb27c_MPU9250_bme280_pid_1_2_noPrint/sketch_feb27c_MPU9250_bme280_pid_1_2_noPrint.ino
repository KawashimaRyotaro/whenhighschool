...
void setup() {
  ...
  while(ch!=2){
    float qmx[]={0,0,0,0,0},qmy[]={0,0,0,0,0},qmz[]={0,0,0,0,0},Smx[]={0,0,0,0,0},Smy[]={0,0,0,0,0},Smz[]={0,0,0,0,0};
    ...
    for(int ch2=0;ch2<=4,ch2++){
      Smx[ch2]=1/((qmx[ch2]-smx)*(qmx[ch2]-smx));
      ssmx+=Smx[ch2];
      Smy[ch2]=1/((qmy[ch2]-smy)*(qmy[ch2]-smy));
      ssmy+=Smy[ch2];
      Smz[ch2]=1/((qmz[ch2]-smz)*(qmz[ch2]-smz));
      ssmz+=Smz[ch2];
    }
    tmx=qmx[0]*Smx[0]/ssmx+qmx[1]*Smx[1]/ssmx+qmx[2]*Smx[2]/ssmx+qmx[3]*Smx[3]/ssmx+qmx[4]*Smx[0]/ssmx;
